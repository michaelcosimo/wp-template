    ...
    <div class="container">
      ...
      <div class="do_container">
        <div class="box arrow-start arrow_bg">
          <div class="img-box">
            <img src="<?php bloginfo('template_url') ?>/images/d-1.png" alt="">
          </div>
        ...
        <div class="box arrow-middle arrow_bg">
          <div class="img-box">
            <img src="<?php bloginfo('template_url') ?>/images/d-2.png" alt="">
          </div>
          <div class="detail-box">
            <h6>
              Development
        ...
        <div class="box arrow-middle arrow_bg">
          <div class="img-box">
            <img src="<?php bloginfo('template_url') ?>/images/d-3.png" alt="">
          </div>
          <div class="detail-box">
            <h6>
              Html5
        ...
        <div class="box arrow-end arrow_bg">
          <div class="img-box">
            <img src="<?php bloginfo('template_url') ?>/images/d-4.png" alt="">
          </div>
          <div class="detail-box">
            <h6>
              Css
        ...
        <div class="box ">
          <div class="img-box">
            <img src="<?php bloginfo('template_url') ?>/images/d-5.png" alt="">
          </div>
          <div class="detail-box">
            <h6>
              Wordpress
      ...
      <div class="carousel-wrap ">
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="<?php bloginfo('template_url') ?>/images/c-1.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                ...
                <img src="<?php bloginfo('template_url') ?>/images/quote.png" alt="">
                <p>
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="<?php bloginfo('template_url') ?>/images/c-2.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Tempor incididunt <br>
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="<?php bloginfo('template_url') ?>/images/c-3.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Tempor incididunt <br>
